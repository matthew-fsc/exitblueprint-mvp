...
gaps = [
    ...
    ("CONTRACT_GAP","Undocumented Recurring Revenue","high",{"type":"sub_score_below","code":"REV-DURABILITY","threshold":70},"REV","CM-BUYERQ-CONTRACTS","PB-RECURRING-CONVERT"),
    ("REV_VOLATILITY","Revenue Inconsistency","med",{"type":"sub_score_below","code":"REV-GROWTH","threshold":50},"REV","CM-BUYERQ-REVDECLINE","PB-REV-STABILITY"),
