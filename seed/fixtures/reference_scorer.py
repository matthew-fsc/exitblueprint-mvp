...
questions = [
    ...
    ("REV-ANNUAL","REV","Annual revenue for each of the last four fiscal years.","numeric_list","",True,5),
    ("REV-NRR","REV","Revenue retention on recurring revenue for the most recent year (%). Enter 'unknown' if not tracked.","numeric_or_unknown","",True,6),
    ...
    ("FIN-CASHFLOW-13WK","FIN","Are you producing a rolling 13-week cash flow forecast?","select","yes|no",False,9),
    ("FIN-CASHFLOW-CYCLICAL","FIN","Is your cash flow cyclical or seasonal?","select","yes|no",False,10),
    ...
    ("CUS-CHURN","CUS","Annual revenue churn from recurring revenue (%).","numeric","",True,3),
    ("CUS-CLIENTS-CHURNED","CUS","Number of clients lost to churn in the last 12 months.","numeric","",False,7),
    ...
    ("GRW-POSITIONING","GRW","Market positioning: defined ideal customer profile, clear differentiation, repeatable sales motion.","select","strong_defined|moderate|undifferentiated_unclear",True,2),
    ...
    ("GOL-PATH","GOL","Rank your preferred exit paths from most to least preferred.","rank","third_party|mgmt_employee|partner|family|step_back_retain",False,2),
